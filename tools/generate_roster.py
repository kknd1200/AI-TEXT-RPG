...
# 등급별 (레벨 1 기준치, 레벨당 성장치).
# 기준치는 등급마다 확실히 벌리되 성장치는 완만하게 벌린다. 성장치까지 크게
# 벌리면 격차가 레벨에 따라 복리로 커져서, 낮은 등급은 아무리 키워도 높은 등급을
# 영영 따라잡지 못한다. 지금 값이면 대략 10레벨 차이가 한 등급을 메운다.
GRADE_TIER = {
    "common": (10, 12), "uncommon": (16, 14), "rare": (24, 16),
    "special": (34, 18), "legend": (46, 20), "god": (60, 22),
}
